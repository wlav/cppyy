...
void pyzables::pass_mine_sp(std::shared_ptr<Countable> ) { }
void pyzables::pass_mine_sp_ref(std::shared_ptr<Countable>& ) { }
void pyzables::pass_mine_sp_ptr(std::shared_ptr<Countable>* ) { }

void pyzables::pass_mine_rp(Countable) {}
void pyzables::pass_mine_rp_ref(const Countable&) {}
void pyzables::pass_mine_rp_ptr(const Countable*) {}
