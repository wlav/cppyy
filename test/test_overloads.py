...
class TestOVERLOADS:
    ...
    def test02_class_based_overloads_explicit_resolution(self):
        ...
        assert c.get_int.__overload__('a_overload*')(a_overload())    == 42
        assert c.__dispatch__('get_int', 'b_overload*')(b_overload()) == 13
        assert c.get_int.__overload__('b_overload*')(b_overload())    == 13
        ...
        assert d.get_int.__overload__('a_overload*')(a_overload())    == 42
        assert d.__dispatch__('get_int', 'b_overload*')(b_overload()) == 13
        assert d.get_int.__overload__('b_overload*')(b_overload())    == 13
